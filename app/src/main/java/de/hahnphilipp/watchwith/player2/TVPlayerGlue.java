...
public class TVPlayerGlue<T extends PlayerAdapter> extends PlaybackBannerControlGlue<T> {
    ...
    public TVPlayerGlue(Context context,
    ...
    public TVPlayerGlue(Context context, int[] seekSpeeds, T impl){
