...
abstract class ProgramGuideFragment<T> : Fragment(), ProgramGuideManager.Listener,
     ...
     */
    override fun onChannelSelected(channel: ChannelUtils.Channel) {
     ...
     * overriding `CAN_FOCUS_CHANNEL` with a true value in your ProgramGuideFragment implementation.
     */
    override fun onChannelClicked(channel: ChannelUtils.Channel) {
        // Override in your implementation
    }
        ...
        when (state) {
            ...
            is State.Error -> {
                ...
                if (state.errorMessage == null) {
                    errorMessage?.setText(R.string.epg_error_fetching_data)
                } else {
     ...
     */
    override fun onChannelClickedInternal(channel: ChannelUtils.Channel) {
     ...
     */
    fun scrollToChannelWithId(channelId: Int) {
